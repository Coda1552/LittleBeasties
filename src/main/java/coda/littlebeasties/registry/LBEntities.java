...
public class LBEntities {
    ...
    public static final RegistryObject<EntityType<Dugoin>> DUGOIN = create("dugoin", EntityType.Builder.of(Dugoin::new, MobCategory.CREATURE).sized(0.6F, 0.5F));
    public static final RegistryObject<EntityType<LeafFly>> LEAF_FLY = create("leaf_fly", EntityType.Builder.of(LeafFly::new, MobCategory.CREATURE).sized(0.5F, 0.5F));
