...
public class DragonfishModel extends EntityModel<Dragonfish> {
	...
	public void setupAnim(Dragonfish entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.CaudalFin.yRot = Mth.cos(-1.0F + limbSwing * speed) * degree * limbSwingAmount;
		...
		this.Body.yRot = Mth.cos(limbSwing * speed) * degree * 0.5F * limbSwingAmount;

		this.LeftBarble.yRot = 0F;
		this.RightBarble.yRot = 0F;

		this.LeftBarble.zRot = -Mth.cos(1.0F + limbSwing * speed) * 0.3F * degree * limbSwingAmount + 0.15F;
		this.RightBarble.zRot = Mth.cos(1.0F + limbSwing * speed) * 0.3F * degree * limbSwingAmount - 0.15F;
	}
